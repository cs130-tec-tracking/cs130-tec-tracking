# Django settings for tectracking project.
...
ADMIN_MEDIA_PREFIX = SITE_ROOT + '/static/grappelli/'

GRAPPELLI_ADMIN_TITLE = 'IBM TEC Tracking'
...
SECRET_KEY = '#t_l_9_as6ibam0^70p#+d*0mbiwsncqf9c@t*ojqvvqq=tmwy'
